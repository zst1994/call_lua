...
function model:newMMApp()
	...
	while true do
		...
		findMultiColorInRegionFuzzy(
			0,
			"8|18|0,16|-1|0,23|8|0,46|16|0,62|3|0,81|12|0,95|13|0,116|17|0,131|12|0",
			100,
			0,
			940,
			749,
...
function model:getPhoneAndToken()
	...
	if phone_table then
		if #phone_table > 0 then
			if #(phone_table[1]:atrim()) < 130 and #(phone_table[1]:atrim()) > 0 then
...
function model:mm(password, sex, updatePass)
	runApp(self.mm_bid)
	mSleep(1000)
	t1 = ts.ms()
	...
	while true do
		...
		findMultiColorInRegionFuzzy(
			0xffffff,
			"73|2|0xffffff,222|-5|0xffffff,-201|-1|0,116|-63|0,421|-1|0,109|55|0,254|1|0,-27|-2|0",
			100,
			0,
			940,
			749,
	...
	while true do
		...
		mSleep(400)
		if
		getColor(249, 520) == 0xd8d8d8 and getColor(411, 524) == 0xffffff or
		getColor(249, 520) == 0xd9d9d9 and getColor(411, 524) == 0xffffff
		then
			mSleep(500)
	...
	function get_mess()
		...
		ts.httpGet("http://47.112.154.69:45678/getsms?token=" .. (self.code_token):atrim(), header_send, body_send)
	...
	while true do
		...
		findMultiColorInRegionFuzzy(
			0x9fa3aa,
			"0|13|0x9fa3aa,8|8|0x9fa3aa,20|8|0x9fa3aa,42|5|0x9fa3aa,40|11|0x9fa3aa,65|9|0x9fa3aa,78|5|0x9fa3aa,93|15|0x9fa3aa,106|13|0x9fa3aa",
			100,
			0,
			0,
			749,
	...
	while true do
		...
		mSleep(400)
		if getColor(443, 234) == 0x848484 and getColor(607, 1001) == 0xffffff then
			break
		end
	...
	while true do
		...
		findMultiColorInRegionFuzzy(
			0x18d9f1,
			"121|-9|0x18d9f1,64|55|0x18d9f1,62|36|0xf6f6f6,-28|12|0xf6f6f6,164|-4|0xf6f6f6,58|328|0xd8d8d8",
			90,
			0,
			0,
			750,
		...
		findMultiColorInRegionFuzzy(
			0xf6f6f6,
			"-75|-88|0x18d9f1,-18|-44|0x18d9f1,47|-57|0x18d9f1,92|-113|0xf6f6f6,-8|-187|0xf6f6f6,-131|367|0xd8d8d8,144|374|0xd8d8d8",
			90,
			0,
			0,
			749,
		...
		--形象示例:相册
		mSleep(400)
		if getColor(459, 1241) == 0x18d9f1 and getColor(650, 1238) == 0x18d9f1 then
			mSleep(500)
			randomsTap(650, 1238, 4)
			mSleep(500)
			break
		end
	...
	while true do
		...
		findMultiColorInRegionFuzzy(
			0x18d9f1,
			"495|25|0x18d9f1,259|-18|0x18d9f1,250|59|0x18d9f1,212|18|0xffffff,238|16|0xffffff,278|17|0xffffff,280|28|0xffffff",
			90,
			0,
			0,
			750,
	...
	while true do
		...
		mSleep(400)
		if
		getColor(491, 813) == 0x7aff and getColor(520, 827) == 0x7aff or
		getColor(481, 808) == 0x57cff and getColor(520, 815) == 0x57cff or
		getColor(481, 808) == 0x47cff and getColor(520, 815) == 0x47cff or
		getColor(481, 808) == 0x37bff and getColor(520, 815) == 0x37bff
		then
			mSleep(500)
		...
		--跳过屏蔽通讯录
		mSleep(400)
		x, y = findMultiColorInRegionFuzzy(0x10000, "19|12|0x10000,71|8|0x10000,119|-5|0x10000", 100, 0, 0, 749, 1333)
		if x ~= -1 and y ~= -1 then
			mSleep(500)
			randomsTap(237, 827, 4)
			mSleep(500)
		...
		findMultiColorInRegionFuzzy(
			0,
			"39|12|0,71|8|0,117|12|0,179|9|0,220|13|0,253|-4|0,304|8|0,330|9|0,410|-6|0",
			90,
			0,
			0,
			749,
		...
		findMultiColorInRegionFuzzy(
			0xd0d0d3,
			"-133|616|0x3ab3fb,-263|580|0x3ab3fb,-271|648|0x3ab3fb,-311|624|0xffffff,-292|614|0xffffff,-277|611|0xffffff,-253|604|0xffffff,-224|616|0xffffff,-422|619|0x3ab3fb",
			90,
			0,
			0,
			749,
	...
	::get_mmId::
	local status, err = pcall(getMMId)
	if status then
		if type(err) ~= "nil" then
			self.mm_accountId = err
			toast("陌陌id:" .. self.mm_accountId, 1)
			mSleep(1000)
		else
			toast("获取陌陌id失败，重新获取", 1)
			mSleep(2000)
			goto get_mmId
		end
	else
	...
	if updatePass == "0" then
		...
		while true do
			...
			mSleep(400)
			if
			getColor(37, 684) == 0x3cc9ff and getColor(39, 771) == 0xff5075 or
			getColor(101, 683) == 0x323232 and getColor(73, 679) == 0x323232 or
			getColor(37, 684) == 0x3fc9ff and getColor(46, 773) == 0x343434
			then
				mSleep(500)
			...
			findMultiColorInRegionFuzzy(
				0x323232,
				"13|16|0x323232,34|12|0x323232,40|12|0x323232,54|8|0x323232,68|14|0x323232,73|11|0x323232,98|9|0x323232,136|8|0xffffff",
				90,
				0,
				610,
				749,
			...
			findMultiColorInRegionFuzzy(
				0x000000,
				"27|0|0x000000,4|20|0x000000,25|21|0x000000,53|8|0x000000,72|13|0x000000,78|12|0x000000,104|15|0x000000,123|0|0x000000",
				90,
				0,
				0,
				750,
			...
			if x ~= -1 and y ~= -1 then
				...
				while true do
					mSleep(400)
					if
					getColor(192, 189) == 0x1e1e1e and getColor(211, 192) == 0x1e1e1e or
					getColor(712, 193) == 0xcccccc
					then
						mSleep(500)
				...
				while true do
					mSleep(400)
					if
					getColor(192, 278) == 0x1e1e1e and getColor(211, 278) == 0x1e1e1e or
					getColor(712, 281) == 0xcccccc
					then
						mSleep(500)
						randomsTap(666, 81, 4)
						mSleep(5000)
...
function model:main()
	...
	ret, password, sex, updatePass = showUI(MyJsonString)
	if ret == 0 then
		dialog("取消运行脚本", 3)
		luaExit()
	end

	if password == "" or password == "默认值" or #password:atrim() == 0 then
	...
	while true do
		...
		if newApp_bool then
			self:mm(password, sex, updatePass)
		end
	end
end

model:main()
http://b12b92daa0f7/zhoushutao/shunmiaofluttermodule.git