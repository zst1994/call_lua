...
function model:mm(password, sex, searchFriend, searchAccount, changeHeader)
    ...
    while true do
        ...
        x, y =
            findMultiColorInRegionFuzzy(
            0x36b6ff,
            "3|-27|0x36b6ff,38|12|0x36b6ff,2|54|0x36b6ff,-40|16|0x36b6ff",
            100,
            0,
            1040,
            749,
    ...
    while (true) do
        ...
        if getColor(239, 629) == 0x12b7f5 then
            ...
            randomTap(395, 357, 4)
            mSleep(500)
            inputKey(self.qqAcount, 20, 50)
            mSleep(500)
            randomTap(447, 477, 4)
            mSleep(500)
            inputKey(self.qqPassword, 20, 50)
            mSleep(500)
            randomTap(239, 629, 4)
            mSleep(500)
            table.remove(tab, 1)
    ...
    while true do
        ...
        x, y =
            findMultiColorInRegionFuzzy(
            0x323333,
            "16|-1|0x323333,8|7|0x323333,10|19|0x323333,24|26|0x323333,30|13|0x323333,25|-7|0x323333,54|-3|0x323333,83|8|0x323333,66|-8|0x323333",
            90,
            0,
            0,
            750,
        ...
        x, y =
            findMultiColorInRegionFuzzy(
            0x007aff,
            "11|1|0x007aff,41|2|0x007aff,40|-188|0x000000,66|-188|0x000000,54|-177|0x000000,79|-177|0x000000,119|-181|0x000000,192|-180|0x000000,260|-185|0x000000",
            90,
            0,
            0,
            750,
    ...
    while true do
        ...
        x, y =
            findMultiColorInRegionFuzzy(
            0x323333,
            "17|0|0x323333,9|8|0x323333,0|17|0x323333,17|17|0x323333,2|6|0xffffff,18|7|0xffffff,10|17|0xffffff,9|-1|0xffffff",
            90,
            0,
            0,
            749,
    ...
    while true do
        ...
        --首页
        mSleep(200)
        x,y = findMultiColorInRegionFuzzy(0x323333, "17|15|0x323333,25|-6|0x323333,35|8|0x323333,53|6|0x323333,77|9|0x323333,73|-3|0x323333,104|1|0x323333,135|8|0x323333,200|6|0xffffff", 90, 0, 0, 750, 1334, { orient = 2 })
        if x ~= -1 then
            mSleep(500)
            toast("首页", 1)
            mSleep(500)
        ...
        --首页
        mSleep(200)
        x,y = findMultiColorInRegionFuzzy(0x3ee1ec, "13|-3|0xfdfdfd,30|5|0x3ee1ec,-2|38|0x13cae2,10|38|0x13cae2,25|31|0x13cae2", 90, 0, 0, 750, 1150, { orient = 2 })
        if x ~= -1 then
            mSleep(500)
            toast("首页", 1)
            mSleep(500)
        ...
        x, y =
            findMultiColorInRegionFuzzy(
            0x323333,
            "4|10|0x323333,13|4|0x323333,17|4|0x323333,32|7|0x323333,47|7|0x323333,42|-1|0x323333,59|5|0xffffff,-20|3|0xffffff,25|27|0xffffff",
            90,
            0,
            0,
            750,
        ...
        x, y =
            findMultiColorInRegionFuzzy(
            0x007aff,
            "20|4|0x007aff,15|3|0x007aff,36|5|0x007aff,38|9|0x007aff,56|6|0x007aff,284|14|0x007aff,304|13|0x007aff,317|12|0x007aff,328|5|0x007aff",
            90,
            0,
            0,
            750,
    ...
    while true do
        ...
        if
            getColor(491, 813) == 0x7aff and getColor(520, 827) == 0x7aff or
                ...
                getColor(481, 808) == 0x47cff and getColor(520, 815) == 0x47cff
         then
            mSleep(500)
            randomTap(237, 827, 4)
            mSleep(500)
        ...
        if getColor(651, 80) == 0x323333 and getColor(621, 82) == 0xffffff then
            ...
            while true do
                ...
                x, y =
                    findMultiColorInRegionFuzzy(
                    0x323333,
                    "2|19|0x323333,0|8|0xffffff,-15|112|0x323333,3|126|0x323333,18|109|0x323333,-7|113|0xffffff,-1|227|0x323333,2|217|0xffffff",
                    100,
                    0,
                    0,
                    125,
