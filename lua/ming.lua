...
function model:wechat(ksUrl,move_type,operator,login_times,content_type,vpn_stauts,phone_token,kn_country,kn_id,countryId,nickName,password,country_len,login_type,addBlack,diff_user,ran_pass,airplaneStatus,tableKey,tmBack,tmFail,EU_countries)
    account_len = 0
    failTM = 0
    old_mess_yzm = ""
...
--      end
    ...
    if vpn_stauts == "1" or vpn_stauts == "2" or vpn_stauts == "3" or vpn_stauts == "5" or vpn_stauts == "6" or vpn_stauts == "7" or vpn_stauts == "8" or vpn_stauts == "9" or vpn_stauts == "10" then
...
function model:main()
    ...
    MyTable = {
        ...
        views = {
            ...
            {
                ["type"] = "RadioGroup",                    
                ["list"] = "柠檬,卡农注册,奥迪,52,俄罗斯1,东帝汶,服务器取号,俄罗斯2,各国API,老友,simsms",
                ["select"] = "0",  
                ["countperline"] = "4",
            },
            {
    ...
    ret, move_type, login_times, content_type, vpn_stauts, kn_country, kn_id, countryId, country_len, login_type, fz_terrace, nickName, password, operator, addBlack, diff_user, ran_pass, airplaneStatus, tableKey, tmBack, tmFail, EU_countries = showUI(MyJsonString)
    if ret == 0 then
        dialog("取消运行脚本", 3)
        luaExit()
    end
    ...
    while true do
        ...
        self:clear_App()
        self:wechat(ksUrl,move_type,operator,login_times,content_type,vpn_stauts,phone_token,kn_country,kn_id,countryId,nickName,password,country_len,login_type,addBlack,diff_user,ran_pass,airplaneStatus,tableKey,tmBack,tmFail,EU_countries)
        mSleep(1000)
    end
end
