...
function model:main()
	...
	MyTable = {
		...
		views = {
			...
			{
				["type"] = "RadioGroup",                    
				["list"] = "柠檬,卡农注册,奥迪,52,俄罗斯1,东帝汶,服务器取号,俄罗斯2,各国API,老友,SMS,越南,各国API2",
				["select"] = "0",  
				["countperline"] = "4",
			},
			{
...
--https://admin.smscodes.io/api/sms/RentSMSNumber?key=3edcec83-89e0-4c13-a1a4-c2a12018422f&sid=05a2666f-850c-41dd-bdc9-48548243f4d9&period=1